...
namespace Jet_fighter
{
    public partial class Form1 : Form
    {
        ...
        private void mainGameTimerEvent(object sender, EventArgs e)
        {
            ...
            if (goRight == true && player.Left < 860)
            {
                player.Left += playerSpeed;
            }
        ...
        private void gameOver()
        {
            isGameOver = true;
            gameTimer.Stop();
            txtScore.Text += Environment.NewLine + "Вы проиграли" +
                Environment.NewLine + " " + Environment.NewLine + "Нажмите  Enter что бы по провобать снова.";
